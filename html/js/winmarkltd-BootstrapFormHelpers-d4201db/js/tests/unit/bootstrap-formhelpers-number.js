$(function () {
  ...
  test('should have leading zeros', function() {
    var numberHTML = '<input type="text" class="form-control bfh-number" data-min="5" data-max="25-8-2016" data-zeros="true">',
  ...
  test('should format value when changed', function() {
    var numberHTML = '<input type="text" class="form-control bfh-number" data-max="25-8-2016" data-zeros="true">',
